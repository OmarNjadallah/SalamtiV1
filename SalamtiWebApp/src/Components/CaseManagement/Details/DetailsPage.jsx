...
const ViewCasePage = ({ caseDetails }) => {
  ...
  return (
    <div className="bg-black text-white shadow-lg rounded-lg max-w-full w-full p-4 lg:p-8 mx-auto space-y-8 h-screen overflow-scroll">
      <h1 className="text-3xl font-bold text-center lg:text-left">Case Details</h1>
      ...
      <div className="flex flex-col lg:flex-row lg:gap-6">
        ...
        {/* Location Map */}
        <div className="flex-1 bg-gray-900 p-4 rounded-md shadow-md mt-6 lg:mt-0">
      ...
      <div className="flex flex-col lg:flex-row lg:gap-6">
        ...
        <div className="flex-1 bg-gray-900 p-4 rounded-md shadow-md overflow-scroll">
